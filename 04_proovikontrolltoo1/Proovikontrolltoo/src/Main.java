...
//
//*2. Koosta funktsioon massiivi libiseva keskmise leidmiseks. Väljundiks on massiiv, mis on
// sisendist kahe elemendi võrra lühem ning mille iga elemendi väärtuseks on sisendmassiivi vastava elemendi ning selle järgmise ja ülejärgmise elemendi keskmine.
//
//*3. Koosta klass, mille eksemplarile saab vastava käsuga lisada arve. Teise käsuga saab
// küsida nende arvude libiseva keskmise massiivi vastavalt eelmise punkti juhendile. Koosta kood nõnda, et uue
// arvu lisamisel eksemplarile tehtaks uusi arvutusi võimalikult vähe (st. ei arvutataks kogu tulemust massiivi algusest uuesti)
